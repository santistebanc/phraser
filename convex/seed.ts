...
export const seedDatabase = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Create exercises for expression1
    ...
    // Create exercises for expression2
    await ctx.db.insert("exercises", {
    ...
    // Create exercises for expression3
    await ctx.db.insert("exercises", {
    ...
    return "Successfully seeded database with 3 expressions and 6 exercises";
  },
});
